...
if __name__ == '__main__':
    ...
    gbt = GradientBoostingRegressor(max_depth=3, loss='lad', n_estimators=1000, verbose=5, n_iter_no_change=5)
    print('Doing 5-fold cross validation')
    cv_result = cross_val_score(gbt, train_prot_windows, train_asas, cv=5, scoring=make_scorer(mean_absolute_error), verbose=100)
    print(cv_result)
